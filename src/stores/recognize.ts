...
import type { useLabel3dStore } from '@/stores/label-3d';
import type { useMaskStore } from '@/stores/mask';

export const useRecognizeStore = (
  id: string,
  canvas: ReturnType<typeof useCanvasStore>,
  label3d: ReturnType<typeof useLabel3dStore>,
  mask: ReturnType<typeof useMaskStore>
) =>
  defineStore(`recognize-${id}`, () => {
