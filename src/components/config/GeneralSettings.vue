<script setup lang="ts">
  import type { ShellType } from '@/services/cmd';
  ...
  <div class="general-settings">
    ...
    <div class="setting-group">
      <div class="setting-item">
        ...
        <el-select
          :model-value="store.config?.log_level"
          placeholder="选择日志级别"
          style="width: 160px"
          @update:model-value="(v: string) => store.handleConfigUpdate('log_level', v)"
        >
      ...
      <div class="setting-item">
        ...
        <el-select
          :model-value="store.config?.frontend.home"
          placeholder="选择首页"
          style="width: 160px"
          @update:model-value="(v: string) => store.handleConfigUpdate('frontend.home', v)"
        >
          <el-option
      ...
      <div class="setting-item">
        ...
        <el-select
          :model-value="store.config?.frontend.mode"
          style="width: 160px"
          @update:model-value="(v: string) => store.handleConfigUpdate('frontend.mode', v)"
        >
          <el-option
      ...
      <div class="setting-item">
        ...
        <el-select
          :model-value="store.config?.shell"
          style="width: 160px"
          @update:model-value="(v: string) => store.handleConfigUpdate('shell', v)"
        >
          <el-option
